...
\begin{itemize}
    ...
    $$
    \ebatchlinJ = \frac{N}{q(2\min(\eta(\rho),\sqrt{\rho}/20))^5}
    $$
    \item Compute powers error:
    $$
    \ebatchpowJ(B) = \ebatchlinJ \cdot(B-1)
    $$
...
\begin{itemize}
    \item Compute linear error:
    $$
    \ebatchlinU = \frac{N}{q\rho}
    $$
    \item Compute powers error:
    $$
    \ebatchpowU( B) = \ebatchlinJ \cdot B
    $$
    \item Compute base error:
\[
